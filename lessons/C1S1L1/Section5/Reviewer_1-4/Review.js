// Slide data
    const slides = [
     {
  type: "vocab",
  title: "Vocabulary – Pronouns & Greetings",
  words: [
    { word: "Ako", meaning: "I / Me", audioSrc: "3.mp3" },
    { word: "Ikaw", meaning: "You", audioSrc: "3.mp3" },
    { word: "Siya", meaning: "He / She", audioSrc: "3.mp3" },
    { word: "Si", meaning: "Marker before names", audioSrc: "3.mp3" },
    { word: "Kamusta?", meaning: "How are you?", audioSrc: "3.mp3" }
  ]
},
{
  type: "vocab",
  title: "Vocabulary – Politeness",
  words: [
    { word: "Salamat", meaning: "Thank you", audioSrc: "3.mp3" },
    { word: "Opo", meaning: "Yes (polite)", audioSrc: "3.mp3" },
    { word: "Hindi po", meaning: "No (polite)", audioSrc: "3.mp3" },
    { word: "Po", meaning: "Politeness particle", audioSrc: "3.mp3" },
...
},
{
  ...
  words: [
    { word: "Ay", meaning: "is / are (used in formal or neutral tone)", audioSrc: "3.mp3" },
    { word: "Mabait", meaning: "Kind", audioSrc: "3.mp3" },
    { word: "Matangkad", meaning: "Tall", audioSrc: "3.mp3" },
    { word: "Maliit", meaning: "Small", audioSrc: "3.mp3" },
    { word: "Matalino", meaning: "Smart", audioSrc: "3.mp3" }
  ]
},
...
{
  type: "true-false",
  sentence: "Salamat means thank you.",
  correctAnswer: "Tama",
  options: ["Tama", "Mali"],
  audioSrc: "3.mp3",
  correctTitle: "Correct!",
...
{
  type: "true-false",
  sentence: "Po is a politeness particle.",
  correctAnswer: "Tama",
  options: ["Tama", "Mali"],
  audioSrc: "3.mp3",
  correctTitle: "Correct!",
...
{
  type: "true-false",
  sentence: "Ay is used like 'is' or 'are' in a sentence.",
  correctAnswer: "Tama",
  options: ["Tama", "Mali"],
  audioSrc: "3.mp3",
  correctTitle: "Correct!",
...
},
{
  ...
  sourceText: "I am kind",
  correctAnswer: "Ako ay mabait",
  wordBank: ["Ako", "ay", "mabait", "ikaw", "matangkad"],
...
{
  type: "translate-phrase",
  sourceText: "You are tall",
  correctAnswer: "Ikaw ay matangkad",
  wordBank: ["Ikaw", "ay", "matangkad", "matalino", "po"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "fill-blank",
  sentence: "Siya ay ______.",
  correctAnswer: "mabait",
  options: ["mabait", "opo"],
  audioSrc: "3.mp3",
  correctTitle: "Awesome!",
  correctSub: "Great job!",
...

{
  ...
  pairs: [
    ...
    { A: "Ako", B: "I / Me", audioA: "3.mp3", audioB: "3.mp3" },
    { A: "Ikaw", B: "You", audioA: "3.mp3", audioB: "3.mp3" }
  ]
},
