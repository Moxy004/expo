...
const slides = [
    ...
    title: "Vocabulary",
    words: [
      { word: "ulam", meaning: "dish", audioSrc: "5.mp3" },
      { word: "kanin", meaning: "rice", audioSrc: "5.mp3" },
      { word: "ang", meaning: "the", audioSrc: "5.mp3" },
      { word: "ito", meaning: "this", audioSrc: "5.mp3" },
    ]
  },
  {
    type: "translate-phrase",
    sourceText: "Ito ang kanin.",
    correctAnswer: "This is the rice",
    wordBank: [
      "is",
      "This",
      "the",
    ...
    correctTitle: "Tama!",
    correctSub: "‘Ito ang kanin’ means ‘This is the rice’.",
    incorrectTitle: "Try again!",
    incorrectSubPrefix: "The correct answer is"
  },
  {
    type: "true-false",
    sentence: "Ito ang ulam. (Is this a correct sentence?)",
    correctAnswer: "True",
    options: ["True", "False"],
    audioSrc: "5.mp3",
    correctTitle: "Correct!",
    correctSub: "‘Ito ang ulam’ is correct.",
    incorrectTitle: "Oops!",
    incorrectSubPrefix: "The correct answer is"
  },
      {
    type: "speak-phrase",
    phrase: "Ito ang kanin",
    ...
    pairs: [
      { A: "Kanin", B: "Rice", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "Ito", B: "This", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "Iyon", B: "That", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "Ulam", B: "Dish", audioA: "5.mp3", audioB: "5.mp3" }
    ]
  },
  {
    type: "fill-blank",
    sentence: "Si Juan ay _____.",
    correctAnswer: "matangkad",
    options: ["kanin", "ulam", "matangkad"],
    audioSrc: "5.mp3",
    correctTitle: "Nice work!",
    correctSub: "‘Si Juan ay matangkad means ‘Juan is tall’.",
    incorrectTitle: "Try again!",
    incorrectSubPrefix: "The correct answer is"
  },
    {
    type: "translate-phrase",
    sourceText: "Mabait, matalino, matangkad",
    correctAnswer: "Kind smart tall",
    wordBank: [
      "Kind",
      "smart",
      "tall",
    ...
    correctTitle: "Tama!",
    correctSub: "You got it correct!",
    incorrectTitle: "Try again!",
    incorrectSubPrefix: "The correct answer is"
  },
      {
    type: "speak-phrase",
    phrase: "Ang ulam ay maliit",
    audioSrc: "3.mp3", // Make sure this path is correct
    correctTitle: "Nice pronunciation!",
    correctSub: "That was perfect.",
    incorrectTitle: "Try again.",
  ...
  {
    type: "image-choice",
    title: "Which one is ‘Ulam’?",
    word: "Ulam",
    audioSrc: "5.mp3",
    correctImageIndex: 0,
    options: ["../S4Pictures/ulam.png", "../S4Pictures/rice.jpg", "../S2Pictures/me.jpeg", "../S1Pictures/hello.png"],
    correctTitle: "Good job!",
    correctSub: "Ulam means viand.",
  ...
  },
  {
    type: "word-choice",
    title: "Which is this?",
    imageSrc: "../S4Pictures/rice.jpg",
    audioSrc: "5.mp3",
    correctWordIndex: 2,
    options: ["Ulam", "Ito", "Kanin", "Ako"],
    correctTitle: "Well done!",
    correctSub: "‘Ulam’ means ‘Dish’.",
    incorrectTitle: "Oops!",
    incorrectSubPrefix: "The correct word is"
  },
    {
    type: "vocab-match",
    title: "Match the words",
    pairs: [
      { A: "Matangkad", B: "tall", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "Mabait", B: "Kind", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "Ang", B: "The", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "Ulam", B: "Dish", audioA: "5.mp3", audioB: "5.mp3" }
    ]
  },
  ...
  {
    type: "fill-blank",
    sentence: "___ ang ulam.",
    correctAnswer: "Ito",
    options: ["Ito", "Kanin"],
    audioSrc: "5.mp3",
    correctTitle: "Good job!",
    correctSub: "‘Ito ang ulam’ means ‘This is the dish’.",
    incorrectTitle: "Not quite.",
    incorrectSubPrefix: "The correct answer is"
  }
];
...
const interactiveWords = {
  ...
  pron: "/ú-lam/",
  ety: "Native",
  meaning: "viand; the main dish eaten with rice"
},
"kanin": {
  pron: "/ka-nin/",
  ety: "Native",
