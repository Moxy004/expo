// Slide data
  ...
  subtitle: "Section 7:Lesson 2",
  phrase: "Masarap",
  translation: "(Delicious)",
  audioSrc: "3.mp3",
  imgSrc: "../S7Pictures/Delicious.jpg"
},
{
    type: "vocab-match",
  ...
  {
  type: "fill-blank",
  sentence: "Ang pagkain ay ______.",
  correctAnswer: "masarap",
  options: ["masarap", "mabagal", "po"],
  audioSrc: "3.mp3",
  ...
  
 {
  ...
  correctAnswer: "Ang pagkain ay masarap.",
  wordBank: ["Ang", "pagkain", "ay", "masarap", "mabait"],
...
},
{
  ...
  word: "Masarap", // word being tested
  audioSrc: "3.mp3",
  correctImageIndex: 3, // index of the correct image
  options: [
    "../S5Pictures/Beautiful.jpg",
    "../S5Pictures/Handsome.jpg",
    "../S5Pictures/mabilis.png",     // Correct
    "../S7Pictures/Delicious.jpg"
  ],
  correctTitle: "Nice!",
  correctSub: "Great job!",
  incorrectTitle: "Not quite.",
  incorrectSubPrefix: "Hmm..."
},
];
const gradedTypes = [
  "translate-phrase",
