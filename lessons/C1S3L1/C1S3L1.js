    ...
    const slides = [
{
    ...
    subtitle: "Section 3: Lesson 1",
    phrase: "Mabait",
    translation: "(Kind :Ex. Ako ay mabait.)",
...
},
{
    ...
    subtitle: "Section 3: Lesson 1",
  phrase: "ay",
  translation: "(is / are — used to link subject and description)",
    audioSrc: "3.mp3" // Replace with audio path if needed
},
 {
  type: "translate-phrase",
  sourceText: "You are kind",
  correctAnswer: "Ikaw ay mabait",
    wordBank: ["Siya", "ay", "mabait", "Oo", "Ikaw"],
...
},
{
  ...
  {
  type: "fill-blank",
  sentence: "Ako ay ________.",
  correctAnswer: "Mabait",
  options: ["Ako", "Mabait", "Siya"],
  audioSrc: "3.mp3",
 ...
 {
  type: "translate-phrase",
  sourceText: "He is kind",
  correctAnswer: "Siya ay mabait",
    wordBank: ["Siya", "ay", "mabait", "Oo", "Kamusta"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
 ...
 {
  type: "translate-phrase",
  sourceText: "Juan is kind",
  correctAnswer: "Si Juan ay mabait",
    wordBank: ["Siya", "ay", "mabait", "Oo", "Juan", "Si"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
