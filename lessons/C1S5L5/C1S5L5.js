    ...
    const slides = [
{
    ...
    {
    type: "vocab",
    title: "Vocabulary - Adjectives to Describe People/Things",
    words: [
        { word: "Mabilis", meaning: "Fast", audioSrc: "3.mp3" },
        { word: "Maganda", meaning: "Beautiful", audioSrc: "3.mp3" },
        { word: "Gwapo", meaning: "Handsome", audioSrc: "3.mp3" },
        { word: "Mabagal", meaning: "Slow", audioSrc: "3.mp3" },
        { word: "At", meaning: "and", audioSrc: "3.mp3" },
    ]
},
{
  type: "vocab-match",
  ...
  pairs: [
    ...
    { A: "At", B: "and", audioA: "3.mp3", audioB: "3.mp3" }
  ]
},

  {
  type: "fill-blank",
  sentence: "Siya ay ________.",
  correctAnswer: "Matangkad",
  options: ["Hindi", "Matangkad", "Kamusta"],
  audioSrc: "3.mp3",
...
},
{
  ...
  sourceText: "Ako ay matalino at mabait",
  correctAnswer: "I am smart and kind",
  wordBank: ["I", "smart", "am", "slow", "kind", "and", "fast"],
...
},
{
  ...
  title: "Vocabulary Matching",
  pairs: [
    { A: "Mabait", B: "Kind", audioA: "3.mp3", audioB: "3.mp3" },
    { A: "Gwapo", B: "Handsome", audioA: "3.mp3", audioB: "3.mp3" },
...
{
    type: "speak-phrase",
    phrase: "Si Juan ay matangkad at gwapo",
...
{
  type: "translate-phrase",
  sourceText: "You are handsome and fast.",
  correctAnswer: "Ikaw ay gwapo at mabilis",
  wordBank: ["Ikaw", "ay", "gwapo", "at", "mabilis"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "translate-phrase",
  sourceText: "She is beautiful and slow.",
  correctAnswer: "Siya ay maganda at mabagal",
  wordBank: ["Siya", "ay", "maganda", "at", "mabagal"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "fill-blank",
  sentence: "Siya ay maganda ______ mabait.",
  correctAnswer: "at",
  options: ["at", "po"],
  audioSrc: "3.mp3",
  correctTitle: "Awesome!",
...
{
    type: "speak-phrase",
    phrase: "Si Maria ay maganda at mabait",
    audioSrc: "3.mp3", // Make sure this path is correct
    correctTitle: "Nice pronunciation!",
    correctSub: "That was perfect.",
    incorrectTitle: "Try again.",
...
{
  type: "translate-phrase",
  sourceText: "He is handsome and smart.",
  correctAnswer: "Siya ay gwapo at matalino",
  wordBank: ["Siya", "ay", "gwapo", "at", "matalino", "opo"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "translate-phrase",
  sourceText: "She is beautiful and kind.",
  correctAnswer: "Siya ay maganda at mabait",
  wordBank: ["Siya", "ay", "maganda", "at", "mabait", "hindi"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "fill-blank",
  sentence: "Ako ay gwapo ______ matalino.",
  correctAnswer: "at",
  options: ["at", "siya"],
  audioSrc: "3.mp3",
  correctTitle: "Awesome!",
...
{
  type: "translate-phrase",
  sourceText: "I am smart and kind.",
  correctAnswer: "Ako ay matalino at mabait",
  wordBank: ["Ako", "ay", "matalino", "at", "mabait"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
    type: "speak-phrase",
    phrase: "Ako ay matalino, mabait at gwapo",
    audioSrc: "3.mp3", // Make sure this path is correct
    correctTitle: "Nice pronunciation!",
    correctSub: "That was perfect.",
    incorrectTitle: "Try again.",
