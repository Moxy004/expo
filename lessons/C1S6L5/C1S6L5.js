// Slide data
    ...
    words: [
        { word: "Masaya", meaning: "Happy", audioSrc: "3.mp3" },
        { word: "Malungkot", meaning: "Sad", audioSrc: "3.mp3" },
        { word: "Pagod", meaning: "Tired", audioSrc: "3.mp3" },
        { word: "Galit", meaning: "Angry", audioSrc: "3.mp3" },
        { word: "Patawad", meaning: "Sorry", audioSrc: "3.mp3" },
    ]
  },
     {
    type: "speak-phrase",
    phrase: "Patawad, Ako ay malungkot",
  ...
  sourceText: "Janelle is smart, tall and kind",
  correctAnswer: "Si Janelle ay matalino matangkad at mabait",
    wordBank: ["mabait", "Kamusta", "Janelle", "ay", "Si", "pagod", "Patawad", "matalino", "at", "matangkad"],
  ...
  incorrectSubPrefix: "The correct answer is"
    ...
    pairs: [
        { A: "Masaya", B: "Happy", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Malungkot", B: "Sad", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Patawad", B: "Sorry", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Maganda", B: "Beautiful", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Matalino", B: "Smart", audioA: "3.mp3", audioB: "3.mp3" },
    ]
},
 {
  type: "translate-phrase",
  sourceText: "Masaya, Malungkot at Maganda",
  correctAnswer: "Happy Sad and Beautiful",
    wordBank: ["Happy", "Hello", "I", "am", "Beautiful", "tired", "Sad", "and"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
 ...
 {
  type: "translate-phrase",
  sourceText: "Patawad, Ako ay maliit at malungkot",
  correctAnswer: "Sorry I am small and sad",
    wordBank: ["sad", "and", "am", "slow", "tired", "angry", "Sorry", "I", "small"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
    ...
    title: "Vocabulary Matching",
    pairs: [
        { A: "Mabilis", B: "Fast", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Mabagal", B: "Slow", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Masaya", B: "Happy", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Matalino", B: "Smart", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Patawad", B: "Sorry", audioA: "3.mp3", audioB: "3.mp3" },
    ]
},
{
  ...
  imageSrc: "../S6Pictures/sorry.jpg", // the image that represents the sentence
  audioSrc: "3.mp3",
  correctWordIndex: 0, // index of the correct word
  options: [
    "Patawad",
    "Masaya",
    "Pagod",     // Correct
...
},
{
  type: "word-choice",
  title: "Choose the correct word",
  imageSrc: "../S6Pictures/happy.png", // the image that represents the sentence
  audioSrc: "3.mp3",
  correctWordIndex: 1, // index of the correct word
  options: [
    "Patawad",
    "Masaya",
    "Pagod",     // Correct
  ...
  correctTitle: "Nice!",
  correctSub: "Masaya means \"Happy\"",
  incorrectTitle: "Not quite.",
  incorrectSubPrefix: "The correct image for"
},
     {
    type: "speak-phrase",
    phrase: "Si Janelle ay maliit at maganda",
    audioSrc: "3.mp3", // Make sure this path is correct
    correctTitle: "Nice pronunciation!",
    correctSub: "That was perfect.",
    incorrectTitle: "Try again.",
 ...
 {
  type: "translate-phrase",
  sourceText: "Siya ay matalino at mabait",
  correctAnswer: "He is smart and kind",
    wordBank: ["Juan", "is", "fast", "happy", "smart", "tall", "angry", "He", "and", "kind"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
 ...
 {
  type: "translate-phrase",
  sourceText: "Si Juan ay galit at pagod",
  correctAnswer: "Juan is angry and exhausted",
    wordBank: ["Sorry", "me", "exhausted", "sad", "am", "angry", "I", "is", "and", "Juan"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
  ...
  {
  type: "true-false",
  sentence: "The English of \"Ulam\" is \"Rice\" ",
  correctAnswer: "False",
  options: ["True", "False"],
  audioSrc: "3.mp3",
  ...
  {
  type: "true-false",
  sentence: "The Filipino of \"Smart\" is \"Patawad\" ",
  correctAnswer: "False",
  options: ["True", "False"],
  audioSrc: "3.mp3",
  correctTitle: "Correct!",
  ...
  incorrectSubPrefix: "The correct answer is"
    ...
    title: "Vocabulary Matching",
    pairs: [
        { A: "Ulam", B: "Dish", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Kanin", B: "Rice", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Ito", B: "This", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Iyon", B: "That", audioA: "3.mp3", audioB: "3.mp3" },
        { A: "Galit", B: "Angry", audioA: "3.mp3", audioB: "3.mp3" },
    ]
},
 {
  type: "translate-phrase",
  sourceText: "Kamusta ka, Ako si Juan",
  correctAnswer: "How are you I am Juan",
    wordBank: ["am", "you", "happy", "not", "is", "Juan", "Me", "I", "and", "How", "are"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
if (slide.type === "speak-phrase" && now < skipSpeakPhraseUntil) {
    currentSlideIndex = index + 1; // ✅ Move the index forward
...
if (typeof wordData === "string") {
  ...
  continueBtn.addEventListener("click", goToNextSlide);
    ...
    if (skipSpeakPhraseUntil && Date.now() < skipSpeakPhraseUntil) {
        // Skip this speak-phrase slide without retrying or duplicating
        goToNextSlide();
        return;
    }
    ...
    skipBtn.addEventListener("click", () => {
        skipSpeakPhraseUntil = Date.now() + 10 * 60 * 1000; // Skip for 10 minutes
        goToNextSlide(); // Skip immediately
    });
    ...
    recognition.onresult = (event) => {
        ...
        if (isCorrect) {
            ...
            // Only add to retryQueue ONCE
            if (!slide.retryCount) {
                slide.retryCount = 1;
                retryQueue.push(slide);
            }
        }
