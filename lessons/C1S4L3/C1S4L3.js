// Slide data
    const slides = [
  {
    ...
    subtitle: "Section 4: Lesson 3",
    phrase: "Ang",
    translation: "(The) Ex: Ang ulam ay maliit (The dish is small)",
    audioSrc: "5.mp3"
  },
  {
    type: "translate-phrase",
    sourceText: "Matangkad si Juan",
    correctAnswer: "Juan is tall",
    wordBank: [
      "Juan",
      "is",
      "tall",
  ...
  },
  {
    ...
    wordBank: ["This", "is", "dish", "rice", "That", "the"],
    correctTitle: "Nice work!",
    correctSub: "You translated it correctly!",
    incorrectTitle: "Oops!",
    incorrectSubPrefix: "The correct answer is"
  },
        {
    type: "translate-phrase",
    sourceText: "Siya ay mabait",
    correctAnswer: "She is kind",
    wordBank: ["This", "is", "dish", "rice", "She", "kind"],
    correctTitle: "Nice work!",
    correctSub: "You translated it correctly!",
    incorrectTitle: "Oops!",
    incorrectSubPrefix: "The correct answer is"
    ...
    subtitle: "Section 4: Lesson 3",
    phrase: "Iyon",
    translation: "(That) Ex: Iyon ay kanin (That is rice)",
    audioSrc: "5.mp3"
  },
          {
    type: "translate-phrase",
    sourceText: "Iyon ang ulam",
    correctAnswer: "That is the dish",
    wordBank: ["This", "is", "dish", "rice", "That", "the"],
    correctTitle: "Nice work!",
    correctSub: "You translated it correctly!",
    incorrectTitle: "Oops!",
    ...
    options: ["kanin", "ulam", "maliit"],
    audioSrc: "5.mp3",
    correctTitle: "Great job!",
    correctSub: "‘Masarap ang ulam’ means ‘The viand is delicious’.",
    incorrectTitle: "Oops!",
    incorrectSubPrefix: "The correct answer is"
  },
    {
  ...
  },
  {
    ...
    title: "Match Food Words",
    pairs: [
      { A: "that", B: "iyon", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "kanin", B: "rice", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "ang", B: "the", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "ulam", B: "dish", audioA: "5.mp3", audioB: "5.mp3" },
      { A: "this", B: "ito", audioA: "5.mp3", audioB: "5.mp3" }
    ]
  },
    {
    type: "word-choice",
    title: "Choose the food word",
    imageSrc: "../S4Pictures/kanin.jpg",
    audioSrc: "5.mp3",
    correctWordIndex: 1,
    options: ["Ulam", "Kanin", "Tubig", "Tinapay"],
    correctTitle: "Great!",
  ...
  {
    type: "true-false",
    sentence: "Ulam is usually eaten with kanin.",
    correctAnswer: "Tama",
    options: ["Tama", "Mali"],
    audioSrc: "5.mp3",
    correctTitle: "Correct!",
    correctSub: "Perfect match!",
