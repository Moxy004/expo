// Slide data
  ...
  subtitle: "Section 7:Lesson 4",
  phrase: "Mapait",
  translation: "(Bitter)",
  audioSrc: "3.mp3",
  imgSrc: "../S7Pictures/Water.jpg"
},
{
  type: "greetingWithImage",
  title: "Food Vocabulary",
...
{
  type: "vocab",
  title: "Vocabulary – Describing Food",
  words: [
    { word: "Pagkain", meaning: "Food", audioSrc: "3.mp3" },
    { word: "Masarap", meaning: "Delicious", audioSrc: "3.mp3" },
    { word: "Tubig", meaning: "Water", audioSrc: "3.mp3" },
  ]
},

{
  ...
  title: "Vocabulary – Describing Food",
  words: [
    { word: "Maasim", meaning: "Sour", audioSrc: "3.mp3" },
    { word: "Matamis", meaning: "Sweet", audioSrc: "3.mp3" },
    { word: "Maalat", meaning: "Salty", audioSrc: "3.mp3" },
    { word: "Mapait", meaning: "Bitter", audioSrc: "3.mp3" }
  ]
},
{
  type: "true-false",
  sentence: "Matamis means sweet.",
  correctAnswer: "Tama",
  options: ["Tama", "Mali"],
  audioSrc: "3.mp3",
...
{
  type: "fill-blank",
  sentence: "Ang pagkain ay ________.",
  correctAnswer: "masarap",
  options: ["masarap", "po", "siya"],
  audioSrc: "3.mp3",
...
{
  type: "vocab-match",
  title: "Match the Taste",
  pairs: [
    { A: "Matamis", B: "Sweet", audioA: "3.mp3", audioB: "3.mp3" },
    { A: "Maasim", B: "Sour", audioA: "3.mp3", audioB: "3.mp3" },
    { A: "Maalat", B: "Salty", audioA: "3.mp3", audioB: "3.mp3" },
    { A: "Mapait", B: "Bitter", audioA: "3.mp3", audioB: "3.mp3" }
  ]
}
