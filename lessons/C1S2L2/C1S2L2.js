// Slide data
    const slides = [
      {
        type: "greeting",
        title: "Pronouns and Self-Introduction",
        subtitle: "Section 2: Lesson 2",
        phrase: "Si",
        translation: "(Marker before names: am/is/are) Examples: Ako si Ana. – I am Ana.",
        audioSrc: "3.mp3" // Replace with audio path if needed
    },
      
  {
  type: "translate-phrase",
  sourceText: "Yes, i am Maria",
  correctAnswer: "Opo ako si Maria",
  wordBank: ["Opo", "ako", "siya", "kamusta","hindi","Maria", "si"],
 ...
 {
  type: "translate-phrase",
  sourceText: "You, how are you?",
  correctAnswer: "Ikaw kamusta ka?",
    wordBank: ["kamusta", "Ikaw", "hindi", "Paalam?", "ka?"],
    correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
},
{
    ...
    pairs: [
        ...
        { A: "Si", B: "am/is/are", audioA: "3.mp3", audioB: "3.mp3" },
    ]
},
