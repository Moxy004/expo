// Slide data
  ...
  sourceText: "You are not Maria.",
  correctAnswer: "Hindi po ikaw si Maria.",
  wordBank: ["Hindi po", "ikaw", "Maria", "Opo", "si"],
...

{
    ...
    pairs: [
        ...
        { A: "Si", B: "am/are/is", audioA: "3.mp3", audioB: "3.mp3" },
    ]
},
 {
  type: "translate-phrase",
  sourceText: "How are you is Lance.",
  correctAnswer: "Kamusta si Lance",
  wordBank: ["Kamusta", "Ikaw", "Lance", "Opo", "si"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "translate-phrase",
  sourceText: "No, Not me",
  correctAnswer: "Hindi, Hindi po ako",
  wordBank: ["Hindi,", "Hindi po", "ako", "siya"],
  correctTitle: "Nice work!",
  correctSub: "You nailed the translation.",
  incorrectTitle: "Oops!",
  incorrectSubPrefix: "The correct answer is"
...
{
  type: "fill-blank",
  sentence: "Hindi po ____, si Juan po",
  correctAnswer: "siya",
  options: ["siya", "Opo"],
  audioSrc: "3.mp3",
  correctTitle: "Awesome!",
...
{
  type: "fill-blank",
  sentence: "_____ si Ana.",
  correctAnswer: "Ako po",
  options: ["Ako po", "Ikaw"],
  audioSrc: "3.mp3",
  correctTitle: "Awesome!",
  correctSub: "Great job",
